...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <meta name="msvalidate.01" content="8DA5E0ED057089BA2BC87C16AA131008" />
    ...
    <body>
        ...
        <div class="container_5">
                    ...
                    <div class="grid_3" style="height:50px; text-align:center;margin-top:0;">
                        <div class="centered_list">
                            <div id="filtre_content" class="filter_container">
                                ...
                                <div class="grid_one" style="margin-left: 20px;">
            ...
            <div id="tuto_on_off" >
                <div class="tuto_button button_header"></div>
            </div>
        ...
        <div id="middle_search_bar_container">
            ...
            <div class="container_5">  
               ...
               <!-- <div id="middle_search_bar" class="index_search_bar grid_3 push_1" style="top:120px;">-->
            ...
            <div class="container_5 ">
                <!--CONCOURS<div class="grid_5" style="height: 100px; top: -140px;text-align:center">
                    <a href="http://minu.me/9fs2" target="_blank"><img src="http://www.grammezero.fr/images/fond_concours.png" /></a>
                    <div style="width:100%;text-align:center;line-height:35px;">
                        Gagnez un exemplaire de l'ebook <a style="font-size:20px" href="http://www.sanspapier.com/search.php#!booksheet_69375">"Clemenceau"</a> de Michel Winock (édité chez PLON, format EPUB sans DRM)
                        <br />
                        <a target="_blank" href="http://minu.me/9fs2">
                            <div style="font-weight:bold;background-color:#39AC81;width:150px;height:40px;line-height:40px;margin:auto;color:#FFF;margin-top:10px;">PARTICIPEZ ! &#9658;</div>
                        </a>
                    </div>
                </div>
                <div class="grid_5" style="height: 100px; top: -120px;text-align:center">
                    <img src="http://www.grammezero.fr/images/home_20130627.jpg" />
                </div>-->
            </div>
        </div>
        ...
        <div id="choose_format_display">
            <div id="choose_format_content">
                ...
                <div id="choose_format_help">Une interrogation sur les formats et protections de fichiers ? Plus d'informations sur notre <a href="aide_en_ligne.php#formats" target="_blank" style="font-size: 12px; color: rosybrown;">aide en ligne</a></div>
            </div>
        </div>
