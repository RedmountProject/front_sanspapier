...
var send_contact = function(){
    $('#send_contact').click(function(){
        var select = document.getElementById("contact_subject");
        var subject = select.options[select.selectedIndex].text;
        var subject_name = select.options[select.selectedIndex].value;
        var text = $("textarea:#contact_text").val();
        var mail = $("input:#contact_mail").val();
        ...
        if(mail)
            var trueMail = isValidEmail(mail);
        
        if(mail && trueMail==true && text){
            $("#contact_thanks").stop().animate({
                'opacity':1
            }, 100, function(){
                $(this).animate({
                    'opacity': 0
            ...
            AjaxController.sendContact(fixedEncodeURIComponent(subject), fixedEncodeURIComponent(subject_name), fixedEncodeURIComponent(text), mail, fixedEncodeURIComponent(name));
